...
ratings = pd.read_csv(r"C:\Users\hp\Downloads\archive (4)\ml-latest-small\ratings.csv")
movies = pd.read_csv(r"C:\Users\hp\Downloads\archive (4)\ml-latest-small\movies.csv")
